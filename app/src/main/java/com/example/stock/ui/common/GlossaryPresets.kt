...
object GlossaryPresets {
    ...
    val HOLDINGS: List<GlossaryItem> = listOf(
        ...
        GlossaryItem("진행중 이력", "예약대기/접수대기처럼 아직 끝나지 않은 주문 상태를 모아 보여줍니다."),
        GlossaryItem("완료 이력", "체결/실패/취소처럼 결과가 확정된 주문 상태를 모아 보여줍니다."),
        GlossaryItem("최근 주문 상태", "방금 누른 수동 매도 요청의 처리 결과를 상단 카드로 즉시 보여줍니다."),
        GlossaryItem("예약대기", "장외/휴장 조건 등으로 장 시작 시점 실행을 기다리는 상태입니다."),
        GlossaryItem("접수대기", "증권사가 주문을 접수했고 최종 체결을 기다리는 상태입니다."),
